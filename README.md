...
SQLite-powered library catalog and circulation system tracking books and member borrowings
...
```bash
python "Simple Library Management System GUI using SQLite in Python/index.py"
```
